...
echo > /etc/init.d/resume.sh '#!/bin/bash
...
# Default-Stop:      0 1 6
# X-Interactive:     true
# Short-Description: Resume upgrade Debian
...
update-rc.d resume.sh remove
rm /etc/init.d/resume.sh
reboot'

chmod +x /etc/init.d/resume.sh
update-rc.d resume.sh defaults
